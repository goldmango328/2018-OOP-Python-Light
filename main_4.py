...
class Images(object):
    ...
    def give_image(self, url, n):
        ...
        lbl.setGeometry(30,30+350*n,260,250)
    ...
    def show_images(self, OtherWindow, room, msg, theme):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0,0,300,90+350*len(image_url)))
        ...
        self.next.setGeometry(QRect(110,10+350*len(image_url),100,50))
        font = QFont()
        font.setBold(True)
    ...
    def NextWindow(self):
        ...
        print(self.theme)
        print(self.object)
        self.ui.show_result(self.window, self.room, self.msg, self.theme, self.object)
        self.window.show()
