...
def get_suburl(data):
    ...
    for i in url:
        ...
        for x in ['goods_no', 'sale_shop_divi_cd', 'sale_shop_no', 'tr_yn', 'conts_form_cd', 'conts_dist_no', 'rel_no',
                  'rel_divi_cd', 'disp_ctg_no']:
...
def jaju_chair(room_size, pic_chart):
    ...
    return ch_name, ch_price, ch_img
...
def jaju_table(room_size, pic_chart):
    ...
    return tb_name, tb_price, tb_img
...
if __name__ == "__main__":
    ...
    # url :: jaju main page
    CHAIR = chair(size, url, chart)
    TABLE = table(size, url, chart)
    ...
    tb_url, tb_name, tb_price, tb_img = TABLE.print_all()
